...
class AnalysisController extends Controller
{
    ...
    {
        $details = Analysis::orderBy('updated_at', 'desc')->get();
        return view('admin.analysis.list', compact('details'));
    }
    ...
    public function store(Request $request)
    {
        ...
        Analysis::create($formInput);
        return redirect()->route('analysis.index')->with('message', 'Analysis Create Successfuly.');
    }
    ...
    {
        $detail = Analysis::findorfail($id);
        return view('admin.analysis.edit', compact('detail'));
    }
    ...
    public function update(Request $request, $id)
    {
      ...
      $oldRecord = Analysis::findorfail($id);
      ...
      return redirect()->route('analysis.index')->with('message', 'Analysis Edited Successfuly.');
    }
    ...
    public function destroy($id)
    {
        ...
        $record->delete();
        return redirect()->route('analysis.index')->with('message', 'Analysis Deleted Successfuly.');
    }
    ...
    public function generateSlug($title, $slug, $oldRecord)
    {
      ...
      $count = Analysis::where('slug', $slugReturn)->count();
