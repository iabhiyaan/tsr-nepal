...
class ArticleController extends Controller
{
    ...
    {
        $details = Article::orderBy('updated_at', 'desc')->get();
        return view('admin.article.list', compact('details'));
    }
    ...
    {
        $articleType = Articletype::wherePublished('Yes')->get();
        return view('admin.article.create', compact('articleType'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('article.index')->with('message', 'Article Create Successfuly.');
    }
    ...
    public function edit($id)
    {
        ...
        $articleType = Articletype::wherePublished('Yes')->get();
        return view('admin.article.edit', compact('detail', 'articleType'));
    }
    ...
    public function update(Request $request, $id)
    {
      ...
      $oldRecord = Article::findorfail($id);
      ...
      return redirect()->route('article.index')->with('message', 'Article Edited Successfuly.');
    }
    ...
    public function destroy($id)
    {
        ...
        $record->delete();
        return redirect()->route('article.index')->with('message', 'Article Deleted Successfuly.');
    }
    ...
    public function generateSlug($title, $slug, $oldRecord)
    {
      ...
      $count = Article::where('slug', $slugReturn)->count();
