...
use App\Models\Ipofpo;
use Image;
use Illuminate\Support\Str;


class IpofpoController extends Controller
{
    /**
    ...
    {
        $details = Ipofpo::orderBy('updated_at', 'desc')->get();
        return view('admin.ipofpo.list', compact('details'));
    }
    ...
    {
        return view('admin.ipofpo.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        Ipofpo::create($formInput);
        return redirect()->route('ipofpo.index')->with('message', 'Ipofpo Create Successfuly.');
    }
    ...
    {
        $detail = Ipofpo::findorfail($id);
        return view('admin.ipofpo.edit', compact('detail'));
    }
    ...
    public function update(Request $request, $id)
    {
      ...
      $oldRecord = Ipofpo::findorfail($id);
      ...
      return redirect()->route('ipofpo.index')->with('message', 'Ipofpo Edited Successfuly.');
    }
    ...
    public function destroy($id)
    {
        ...
        $record->delete();
        return redirect()->route('ipofpo.index')->with('message', 'Ipofpo Deleted Successfuly.');
    }
    ...
    public function generateSlug($title, $slug, $oldRecord)
    {
      ...
      $count = Ipofpo::where('slug', $slugReturn)->count();
