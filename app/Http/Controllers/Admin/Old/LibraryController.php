...
class LibraryController extends Controller
{
    ...
    {
        $details = Library::orderBy('updated_at', 'desc')->get();
        return view('admin.library.list', compact('details'));
    }
    ...
    public function store(Request $request)
    {
        ...
        Library::create($formInput);
        return redirect()->route('library.index')->with('message', 'Library Create Successfuly.');
    }
    ...
    {
        $detail = Library::findorfail($id);
        return view('admin.library.edit', compact('detail'));
    }
    ...
    public function update(Request $request, $id)
    {
      ...
      $oldRecord = Library::findorfail($id);
      ...
      return redirect()->route('library.index')->with('message', 'Library Edited Successfuly.');
    }
    ...
    public function destroy($id)
    {
        ...
        $record->delete();
        return redirect()->route('library.index')->with('message', 'Library Deleted Successfuly.');
    }
    ...
    public function generateSlug($title, $slug, $oldRecord)
    {
      ...
      $count = Library::where('slug', $slugReturn)->count();
