...
class MarketController extends Controller
{
    ...
    {
        $details = Market::orderBy('updated_at', 'desc')->get();
        return view('admin.market.list', compact('details'));
    }
    ...
    public function store(Request $request)
    {
        ...
        Market::create($formInput);
        return redirect()->route('market.index')->with('message', 'Market Create Successfuly.');
    }
    ...
    {
        $detail = Market::findorfail($id);
        return view('admin.market.edit', compact('detail'));
    }
    ...
    public function update(Request $request, $id)
    {
      ...
      $oldRecord = Market::findorfail($id);
      ...
      return redirect()->route('market.index')->with('message', 'Market Edited Successfuly.');
    }
    ...
    public function destroy($id)
    {
        ...
        $record->delete();
        return redirect()->route('market.index')->with('message', 'Market Deleted Successfuly.');
    }
    ...
    public function generateSlug($title, $slug, $oldRecord)
    {
      ...
      $count = Market::where('slug', $slugReturn)->count();
