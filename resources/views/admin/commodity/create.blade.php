...
<div class="page-content fade-in-up">
                <div class="row">
                    <div class="col-md-12">
                        <div class="ibox">
                            <div class="ibox-head">
                                <div class="ibox-title">Create Commodity</div>
                            ...
                            <div class="ibox-body" style="">
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-6 form-group">
                                      <label>Unit</label>
                                      <input class="form-control" name="unit" value="{{old('unit')}}" type="text" placeholder="Enter Unit">
                                  </div>
                                ...
                                <div class="form-group">
                                    <label>Order</label>
                                    <input class="form-control" type="number" name="order" value="" placeholder="Enter Order">
                                </div>
