...
<div class="page-heading">
    <h1 class="page-title">Commodity</h1>
    <!-- <ol class="breadcrumb">
...
<div class="page-content fade-in-up">
    <div class="ibox">
        <div class="ibox-head">
            <div class="ibox-title">All Commodity</div>
            <div>
                <a class="btn btn-info btn-md" href="{{route('commodity.create')}}">Add Commodity</a>
            </div>
        </div>
                  ...
                  @if($details->count())
                    ...
                    <tr>
                      ...
                      <td>{{$data->published}}</td>
                        ...
                        <td>
                            <a href="{{route('commodity.edit', $data->id)}}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>

                              <form class="adjust-delete-button" action="{{route('commodity.destroy', $data->id)}}" method="post">
                                  @csrf
                                  @method('delete')
