...
<div class="page-content fade-in-up">
  <form method="post" action="{{route('analysis.store')}}" enctype="multipart/form-data">
    @csrf
            ...
            <div class="ibox">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="ibox">
                            <div class="ibox-head">
                                <div class="ibox-title">Create Analysis</div>
                            ...
                            <div class="ibox-body" style="">
                              ...
                              <div class="row">
                                  ...
                                  <div class="form-group col-md-4">
                                      <label>Title</label>
                                      <input class="form-control" name="title" value="{{old('title')}}" type="text" placeholder="Enter Analysis Title">
                                  </div>

                                  <div class="form-group col-md-4">
                                      <label>Slug</label>
                                      <input class="form-control" name="slug" value="{{old('slug')}}" type="text" placeholder="Enter Analysis Slug">
                                  </div>
