...
<div class="page-content fade-in-up">
  <form method="post" action="{{route('analysis.update', $detail->id)}}" enctype="multipart/form-data">
    @csrf
    @method('put')
            ...
            <div class="ibox">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="ibox">
                            <div class="ibox-head">
                                <div class="ibox-title">Edit Analysis</div>
                              ...
                              <div class="row">
                                  ...
                                  <div class="form-group col-md-4">
                                        ...
                                        <select name="type" class="form-control">
                                            ...
                                            <option value="Technical" {{$detail->type == 'Technical' ? 'selected' : ''}}>Technical</option>
                                            <option value="Fundamental" {{$detail->type == 'Fundamental' ? 'selected' : ''}}>Fundamental</option>
