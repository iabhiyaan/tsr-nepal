...
<div class="page-content fade-in-up">
    <div class="ibox">
        <div class="ibox-head">
            <div class="ibox-title">All Forum</div>
            <div>
                <a class="btn btn-info btn-md" href="{{route('forum.create')}}">Add Forum</a>
            </div>
        </div>
                  ...
                  @if($details->count())
                    ...
                    <tr>
                      ...
                      <!-- <td>{{$data->homepage == 1 ? 'Yes' : 'No'}}</td> -->
                        ...
                        <td>
                            <a href="{{route('forum.edit', $data->id)}}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>

                              <form class="adjust-delete-button" action="{{route('forum.destroy', $data->id)}}" method="post">
                                  @csrf
                                  @method('delete')
