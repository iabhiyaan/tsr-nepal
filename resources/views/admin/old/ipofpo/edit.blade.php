...
<div class="page-content fade-in-up">
  <form method="post" action="{{route('ipofpo.update', $detail->id)}}" enctype="multipart/form-data">
    @csrf
    @method('put')
            ...
            <div class="ibox">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="ibox">
                            <div class="ibox-head">
                                <div class="ibox-title">Edit Ipofpo</div>
                            ...
                            <div class="ibox-body" style="">
                              ...
                              <div class="row">
                                  ...
                                  <div class="form-group col-md-6">
                                      <label>Title</label>
                                      <input class="form-control" name="title" value="{{$detail->title}}" type="text" placeholder="Enter Ipofpo Title">
                                  </div>

                                  <div class="form-group col-md-6">
                                      <label>Slug</label>
                                      <input class="form-control" name="slug" value="{{$detail->slug}}" type="text" placeholder="Enter Ipofpo Slug">
                                  </div>
