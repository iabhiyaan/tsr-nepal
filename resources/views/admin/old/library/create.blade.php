            ...
            <div class="ibox">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="ibox">
                            <div class="ibox-head">
                                <div class="ibox-title">Create Library</div>
                            ...
                            <div class="ibox-body" style="">
                              ...
                              <div class="row">
                                  ...
                                  <div class="form-group col-md-4">
                                      <label>Title</label>
                                      <input class="form-control" name="title" value="{{old('title')}}" type="text" placeholder="Enter Library Title">
                                  </div>

                                  <div class="form-group col-md-4">
                                      <label>Slug</label>
                                      <input class="form-control" name="slug" value="{{old('slug')}}" type="text" placeholder="Enter Library Slug">
                                  </div>
                                  ...
                                  <div class="form-group col-md-4">
                                        ...
                                        <select name="type" class="form-control">
                                            ...
                                            <option value="Stratigies">Stratigies</option>
                                            <option value="Tools">Tools</option>
                                            <option value="Finance Glosary">Finance Glosary</option>
                                        </select>
                                  </div>
                              </div>
