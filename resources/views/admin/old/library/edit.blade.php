...
<div class="page-content fade-in-up">
  <form method="post" action="{{route('library.update', $detail->id)}}" enctype="multipart/form-data">
    @csrf
    @method('put')
            ...
            <div class="ibox">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="ibox">
                            <div class="ibox-head">
                                <div class="ibox-title">Edit Library</div>
                            ...
                            <div class="ibox-body" style="">
                              ...
                              <div class="row">
                                  ...
                                  <div class="form-group col-md-4">
                                      <label>Title</label>
                                      <input class="form-control" name="title" value="{{$detail->title}}" type="text" placeholder="Enter Library Title">
                                  </div>

                                  <div class="form-group col-md-4">
                                      <label>Slug</label>
                                      <input class="form-control" name="slug" value="{{$detail->slug}}" type="text" placeholder="Enter Library Slug">
                                  </div>
                                  <div class="form-group col-md-4">
                                        <label>Select Library Type</label>
                                        <select name="type" class="form-control">
                                            <option value="">--select one--</option>

                                            <option value="Story" {{$detail->type == 'Story' ? 'selected' : ''}}>Story</option>
                                            <option value="Stratigies" {{$detail->type == 'Stratigies' ? 'selected' : ''}}>Stratigies</option>
                                            <option value="Tools" {{$detail->type == 'Tools' ? 'selected' : ''}}>Tools</option>
                                            <option value="Finance Glosary" {{$detail->type == 'Finance Glosary' ? 'selected' : ''}}>Finance Glosary</option>
