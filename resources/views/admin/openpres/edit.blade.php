...
<div class="page-content fade-in-up">
  <form method="post" action="{{route('openpress.update', $detail->id)}}" enctype="multipart/form-data">
    @csrf
    @method('put')
            ...
            <div class="ibox">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="ibox">
                            <div class="ibox-head">
                                <div class="ibox-title">Edit Openpress</div>
                            ...
                            <div class="ibox-body" style="">
                              ...
                              <div class="row">
                                  ...
                                  <div class="form-group col-md-4">
                                      <label>Title</label>
                                      <input class="form-control" name="title" value="{{$detail->title}}" type="text" placeholder="Enter Article Title">
                                  </div>

                                  <div class="form-group col-md-4">
                                      <label>Slug</label>
                                      <input class="form-control" name="slug" value="{{$detail->slug}}" type="text" placeholder="Enter Article Slug">
                                  </div>

                                  <div class="form-group col-md-4">
                                      <label>Author</label>
                                      <input class="form-control" name="author" value="{{$detail->author}}" type="text" placeholder="Enter Author">
                                  </div>
                                ...
                                {{--
                                  ...
                                  <div class="check-list col-md-4 ">
                                      ...
                                      <span class="input-span"></span>Exclusive Article</label>
                                  </div>
                               --}}
                                </div>
                                  <br>
