...
@push('styles')
<style media="screen">
/* trading view logo display none */
a.button-1dpg_T2E-.button--right-2CEhpGhn- {
    display: none;
}
</style>
            ...
            <div class="container">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                    ...
                    @foreach(@$latestArticles as $article)
                            <li><a href="{{route('dynamicNav', [@$article->getSlugFromNavigation(), @$article->slug])}}">{{@$article->title}}</a></li>
                    @endforeach
...
<!-- crypto currencies trading view widget -->
{{--
                    ...
                    @endif
                          ...
                          <div class="col-lg-4 col-md-12 col-sm-12">
                            ...
                            @foreach(@$allLatestNews as $latestNews)
                                <a class="small-news-wrapper" href="{{route('dynamicNav', [@$latestNews->getSlugFromNavigation(), @$latestNews->slug])}}">
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-12 col-sm-12">
                        ...
                        <div class="row">
                          ...
                          @if(@$shareMarketArticle !== null)
                             @if(@$shareMarketArticle->count() >= 2)
                                <div class="two-block-news-wrapper">

                                    <a href="{{route('dynamicNav', [@$shareMarketArticle->first()->getSlugFromNavigation(), @$shareMarketArticle->first()->slug])}}">
                                        <figure style="background-image: url('{{asset('images/main/'.@$shareMarketArticle->first()->main_image)}}')"></figure>
                                        <div class="two-block-news-content">
                                            <h3>{{@$shareMarketArticle->first()->title}}</h3>
                                            <span>{{\Carbon\Carbon::parse(@$shareMarketArticle->first()->created_at)->format('M d,Y')}}</span>
                                            <p>{{str_limit(@$shareMarketArticle->shift()->short_description, 100)}}</p>
                                        </div>
                                    </a>
                        ...
                        @endif
                            ...
                            <div class="col-lg-4 col-md-12 col-sm-12">
                              ...
                              @foreach(@$shareMarketArticle as $latestNews)
                                    <a class="small-news-wrapper" href="{{route('dynamicNav', [@$latestNews->getSlugFromNavigation(), @$latestNews->slug])}}">
                                        <figure style="background-image: url('{{asset('images/main/'.@$latestNews->main_image)}}')"></figure>
                                        <div class="two-block-small-news-content">
                                            <h3>{{@$latestNews->title}}</h3>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                      ...
                      @foreach(@$exclusiveArticles as $exclusive)
                            <a href="{{route('dynamicNav', [@$exclusive->getSlugFromNavigation(), @$exclusive->slug])}}">
...
<!-- remaningCategoryWiseArticles -->
        <section class="four-block-section">
            <div class="container">
                <div class="row">

            @if(@$remaningCategoryWiseArticles->count() == 5)
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="four-block-first-sec">
                            <a class="four-block-first-sec-wrapper" href="{{route('dynamicNav', [@$remaningCategoryWiseArticles->first()->getSlugFromNavigation(), @$remaningCategoryWiseArticles->first()->slug])}}">
                                <span class="section-title four-block-first-sec-news-title">{{@$remaningCategoryWiseArticles->first()->category->name}}</span>
                                <figure style="background-image: url('{{asset('images/main/'.@$remaningCategoryWiseArticles->first()->main_image)}}')"></figure>
                                <div class="first-section-content">
                                    <h3>{{@$remaningCategoryWiseArticles->first()->title}}</h3>
                                    <div class="first-sec-date-wrap"><span>{{\Carbon\Carbon::parse(@$remaningCategoryWiseArticles->first()->created_at)->format('M d,Y')}}</span><p><i class="fa fa-clock-o" aria-hidden="true"></i>{{\Carbon\Carbon::parse(@$newArticle->created_at)->format('h:i')}}</p></div>
                                    <p>{{str_limit(@$remaningCategoryWiseArticles->shift()->short_description, 200)}}</p>
                                </div>
                            </a>
                            ...
                            <a class="four-block-first-sec-wrapper" href="{{route('dynamicNav', [@$remaningCategoryWiseArticles->first()->getSlugFromNavigation(), @$remaningCategoryWiseArticles->first()->slug])}}">
                                ...
                                <div class="first-section-content">
                                    <h3>{{@$remaningCategoryWiseArticles->first()->title}}</h3>
                                    <div class="first-sec-date-wrap"><span>{{\Carbon\Carbon::parse(@$remaningCategoryWiseArticles->first()->created_at)->format('M d,Y')}}</span><p><i class="fa fa-clock-o" aria-hidden="true"></i>{{\Carbon\Carbon::parse(@$remaningCategoryWiseArticles->first()->created_at)->format('h:i')}}</p></div>
                                    <p>{{str_limit(@$remaningCategoryWiseArticles->shift()->short_description, 200)}}</p>
                                </div>
                            </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        ...
                        <a class="four-block-second-section" href="{{route('dynamicNav', [@$remaningCategoryWiseArticles->first()->getSlugFromNavigation(), @$remaningCategoryWiseArticles->first()->slug])}}">
                        <span class="section-title four-block-news-title">{{@$remaningCategoryWiseArticles->first()->category->name}}</span>
                            <figure style="background-image:url('{{asset('images/main/'.@$remaningCategoryWiseArticles->first()->main_image)}}')"></figure>
                            <div class="second-section-content">
                                <h3> {{@$remaningCategoryWiseArticles->shift()->title}} </h3>
                            </div>
                        </a>

                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <a class="interview-section" href="{{route('dynamicNav', [@$remaningCategoryWiseArticles->first()->getSlugFromNavigation(), @$remaningCategoryWiseArticles->first()->slug])}}">
                            <span class="section-title">{{@$remaningCategoryWiseArticles->first()->category->name}}</span>
                            <figure style="background-image:url('{{asset('images/main/'.@$remaningCategoryWiseArticles->first()->main_image)}}')"></figure>
                            <div class="interview-content">
                                <h4>{{@$remaningCategoryWiseArticles->first()->title}}</h4>
                                <div class="interview-date"><span>{{\Carbon\Carbon::parse(@$remaningCategoryWiseArticles->first()->created_at)->format('M d,Y')}}</span><p><i class="fa fa-clock-o" aria-hidden="true"></i>{{\Carbon\Carbon::parse(@$remaningCategoryWiseArticles->first()->created_at)->format('h:i')}}</p></div>
                                <p>{{str_limit(@$remaningCategoryWiseArticles->shift()->short_description, 200)}} </p>
                            </div>
                        </a>
                        <a class="interview-section" href="{{route('dynamicNav', [@$remaningCategoryWiseArticles->first()->getSlugFromNavigation(), @$remaningCategoryWiseArticles->first()->slug])}}">
                            <span class="section-title ipo-title">{{@$remaningCategoryWiseArticles->first()->category->name}}</span>
                            <figure style="background-image:url('{{asset('images/main/'.@$remaningCategoryWiseArticles->first()->main_image)}}')"></figure>
                            <div class="interview-content">
                                <h4>{{@$remaningCategoryWiseArticles->first()->title}}</h4>
                                <div class="interview-date"><span>{{\Carbon\Carbon::parse(@$remaningCategoryWiseArticles->first()->created_at)->format('M d,Y')}}</span><p><i class="fa fa-clock-o" aria-hidden="true"></i>{{\Carbon\Carbon::parse(@$remaningCategoryWiseArticles->first()->created_at)->format('h:i')}}</p></div>
